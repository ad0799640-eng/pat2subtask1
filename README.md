...
Related Topics: telegraph Today in History—May 2: A War Changed by the Blink of an Eye code International Morse Code
On the Web: BBC Bitesize - What is Morse code? (Apr. 27, 2026)
Get amazed as Guglielmo Marconi sends and receive wireless radio message across the Atlantic
Get amazed as Guglielmo Marconi sends and receive wireless radio message across the AtlanticItalian physicist and inventor Guglielmo Marconi demonstrating the wireless radio device, which was used to transmit Morse Code over the Atlantic Ocean in 1901; excerpt from a newsreel.
...
link of resource
http://britannica.com/topic/Morse-Code
